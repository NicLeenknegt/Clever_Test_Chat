import { MessageType, ADD_MESSAGE, MessageActionTypes, LOADING_MESSAGE, ERROR_MESSAGE, SELECT_MESSAGE, SELECT_TAG, SET_INPUT, SET_TO_INITIAL_STATE, IS_TESTING, FORWARD_PAGINATION, BACKWARD_PAGINATION, SET_MAX_PAGES, SET_PRODUCTS_PER_PAGE, SET_RECOMMENDATIONS } from './types'
